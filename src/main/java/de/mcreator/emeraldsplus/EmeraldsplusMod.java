...
import de.mcreator.emeraldsplus.init.EmeraldsplusModTabs;
import de.mcreator.emeraldsplus.init.EmeraldsplusModItems;

public class EmeraldsplusMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(EmeraldsplusMod.class);
	public static final String MODID = "emeraldsplus";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing EmeraldsplusMod");
		EmeraldsplusModTabs.load();
		EmeraldsplusModItems.load();
		tick();
